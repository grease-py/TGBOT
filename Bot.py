...
# Start function that gets triggered by the /start command
def start(update, context):
    update.message.reply_text('Welcome! Send "fatgf" to calculate the average win rate for FATGF wallets. Use /last100 to get the average win rate for the last 100 wallets scanned.')
