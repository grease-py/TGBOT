...
def analyze_fatgf(update, context):
    win_rates = []
    ...
    for wallet_address in wallet_addresses:
        try:
            ...
            data = loop.run_until_complete(fetch_all_transactions(wallet_address))
            loop.close()
...
def start(update, context):
    update.message.reply_text('Welcome! Send "fatgf" to calculate the average win rate for FATGF wallets.')
